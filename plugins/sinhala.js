...
const { PixaldrainDL } = require("mrnima-moviedl");
...
cmd({
    ...
    try {
        ...
        let message = "📺 Search Results for 𝑸𝑼𝑬𝑬𝑵 𝑪𝑰𝑵𝑬𝑴𝑨\n\n*🔢 Reply Below Number*\n\n";
        result.results.forEach((item, index) => {
            message += `${index + 1}. *${item.title}*\n🗓️Type : *${item.type}*\n📎 Link : ${item.link}\n\n`;
        });

        const sentMsg = await conn.sendMessage(from, {
            image: { url: 'https://i.ibb.co/fV8G0y1W/8352.jpg' },
            caption: message,
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
                ...
                externalAdReply: {
                    title: '𝑸𝑼𝑬𝑬𝑵 𝑪𝑰𝑵𝑬𝑴𝑨',
                    body: 'ᴀ 𝑸𝑼𝑬𝑬𝑵 𝑪𝑰𝑵𝑬𝑴𝑨 ᴡᴀ ʙᴏᴛ ʙᴇꜱᴇᴅ ᴏɴ ʙᴀɪʏʟᴇꜱ',
                    mediaType: 1,
                    sourceUrl: "https://www.youtube.com/@shanstudio-n-x",
                    thumbnailUrl: 'https://i.ibb.co/fV8G0y1W/8352.jpg',
        ...
        const messageListener = async (update) => {
            ...
            movieMessage += `*㋛ 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 ꧁𝚀𝚄𝙴𝙴𝙽 〽️Ｄ ʙʏ 𝙳𝙸𝙻𝙸𝚂𝙷𝙰 ʏᴛ*`;
            ...
            const qualityListener = async (update) => {
                ...
                const sentMsg = await conn.sendMessage(from, {
                                ...
                                mimetype: 'video/mp4',
                                fileName: `🍿㋛ 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 ꧁𝚀𝚄𝙴𝙴𝙽 〽️Ｄ ᴍᴏᴠɪᴇ ᴜᴘʟᴏᴅᴇʀ.mp4`,
                                caption: `${movie.title}\n\n*㋛ 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 ꧁𝚀𝚄𝙴𝙴𝙽 〽️Ｄ ʙʏ 𝙳𝙸𝙻𝙸𝚂𝙷𝙰 ʏᴛ*`,
                 contextInfo: {
                forwardingScore: 999,
                isForwarded: false,
                forwardedNewsletterMessageInfo: {
