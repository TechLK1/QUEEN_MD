      ...
      if (_0x4dbcb0) {
        ...
        if (_0x1e75d9 === "1.1") {
          await _0xaf8db8.sendMessage(_0x5eb615, {
            ...
            'caption': "*© Gᴇɴʀᴇʀᴀᴛᴇᴅ Bʏ 𝚀𝚄𝙴𝙴𝙽_𝙼𝙳*"
          }, {
            'quoted': _0x2405c0
          });
        } else {
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "𝚀𝚄𝙴𝙴𝙽_𝙼𝙳 | " + _0x1d0aed.title + '.mp4',
...
cmd({
  ...
  try {
    ...
    let _0x563ad3 = "📽️ *Search Results for 𝑸𝑼𝑬𝑬𝑵 𝑪𝑰𝑵𝑬𝑴𝑨* \"" + _0x2f9e41 + "\":\n\n";
